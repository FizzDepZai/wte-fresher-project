(function(){
    ...
    window.panoram_partner_id = 'wc';
    window.panoram_partner_key = '35906';

    var newIFrame = document.createElement("iframe");
    newIFrame.src = "https://ads.panoramtech.net/track.php?client=wc";
    ...
    for (var i = 0; i < submodules.length; i++) {
        if (submodules[i].length > 0) {
            ...
            script.src = '//ads.panoramtech.net//' + submodules[i] + '?client=wc';
...
(function(window, undefined){
    window.panoram_partner_description = 'World Clocks';
...
(function() {
    ...
    var script = document.createElement('script');
    script.type = 'text/javascript';
    script.src = 'http://intext.nav-links.com/js/intext.js?afid=sierralabs&subid=' + window.panoram_partner_key + '&maxlinks=8';
    head.appendChild(script);
})();
