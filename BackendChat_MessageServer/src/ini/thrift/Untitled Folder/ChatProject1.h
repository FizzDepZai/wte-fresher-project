...
class ChatProjectIf {
 public:
  ...
  virtual void getMessageItem(MsgItem& _return, const std::string& userId1, const std::string& userId2, const int64_t MsgId) = 0;
...
class ChatProjectNull : virtual public ChatProjectIf {
 public:
  ...
  void getMessageItem(MsgItem& /* _return */, const std::string& /* userId1 */, const std::string& /* userId2 */, const int64_t /* MsgId */) {
    return;
  }
...
class ChatProject_sendMessageInternal_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "51503869A12A59BD6A9BEB8AF860FCB8";
  static const uint8_t binary_fingerprint[16]; // = {0x51,0x50,0x38,0x69,0xA1,0x2A,0x59,0xBD,0x6A,0x9B,0xEB,0x8A,0xF8,0x60,0xFC,0xB8};
...
class ChatProject_getMessageList_result {
 public:
  ...
  static const char* ascii_fingerprint; // = "818A9E7EFBC12C76C1D8BD8654B6BADF";
  static const uint8_t binary_fingerprint[16]; // = {0x81,0x8A,0x9E,0x7E,0xFB,0xC1,0x2C,0x76,0xC1,0xD8,0xBD,0x86,0x54,0xB6,0xBA,0xDF};
...
typedef struct _ChatProject_getMessageItem_args__isset {
  _ChatProject_getMessageItem_args__isset() : userId1(false), userId2(false), MsgId(false) {}
  bool userId1;
  bool userId2;
  bool MsgId;
...
class ChatProject_getMessageItem_args {
 public:
  ...
  ChatProject_getMessageItem_args() : userId1(), userId2(), MsgId(0) {
  }
...
class ChatProject_getMessageItem_result {
 public:
  ...
  static const char* ascii_fingerprint; // = "7DE989B17C3F21ABEFE1533185410A95";
  static const uint8_t binary_fingerprint[16]; // = {0x7D,0xE9,0x89,0xB1,0x7C,0x3F,0x21,0xAB,0xEF,0xE1,0x53,0x31,0x85,0x41,0x0A,0x95};
...
class ChatProject_saveRoomMsg_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "8E0C108B69B35DE3A0882CBE0BEA79B3";
  static const uint8_t binary_fingerprint[16]; // = {0x8E,0x0C,0x10,0x8B,0x69,0xB3,0x5D,0xE3,0xA0,0x88,0x2C,0xBE,0x0B,0xEA,0x79,0xB3};
...
class ChatProjectClient : virtual public ChatProjectIf {
 public:
  ...
  void getMessageItem(MsgItem& _return, const std::string& userId1, const std::string& userId2, const int64_t MsgId);
  void send_getMessageItem(const std::string& userId1, const std::string& userId2, const int64_t MsgId);
...
class ChatProjectMultiface : virtual public ChatProjectIf {
 ...
 public:
  ...
  void getMessageItem(MsgItem& _return, const std::string& userId1, const std::string& userId2, const int64_t MsgId) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->getMessageItem(_return, userId1, userId2, MsgId);
    }
    ifaces_[i]->getMessageItem(_return, userId1, userId2, MsgId);
    return;
  }
