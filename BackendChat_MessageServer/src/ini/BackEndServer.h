...
private:
    ...
    Poco::ThreadPool *workPoolMessageId, *workPoolMessageItem, *workPoolMessageOffline;
//    Database* database;
    vector<DataStructure*> database;
    vector<JobWorker*> workers;
    WriteToDBWorkers* writeToDBWorkers;
    static KeyGenerate* keyGen;
    Poco::NotificationQueue jobQueueMessageId, jobQueueMessageItem, jobQueueMessageOffline;
